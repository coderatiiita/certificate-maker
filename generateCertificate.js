...
async function generateCertificate(orgName, courseName, studentName, professor, director) {
    return new Promise((resolve, reject) => {
        wrapper(orgName, courseName, studentName, professor, director);
        return resolve();
    });
}

function wrapper(orgName, courseName, studentName, professor, director) {
    ...
    doc
        ...
        .fontSize(10)
        .fill('#021c27')
        .text(`Successfully completed the ${courseName}.`, {
            align: 'center',
        });
    ...
    doc
        ...
        .fontSize(10)
        .fill('#021c27')
        .text(`${professor}`, startLine1, signatureHeight + 10, {
            columns: 1,
            columnGap: 0,
            height: 40,
            width: lineSize,
    ...
    doc
        ...
        .fontSize(10)
        .fill('#021c27')
        .text(`${director}`, startLine3, signatureHeight + 10, {
            columns: 1,
            columnGap: 0,
            height: 40,
            width: lineSize,
